...
QT_MOC_LITERAL(3, 23, 25), // "on_pushButton_add_clicked"
QT_MOC_LITERAL(4, 49, 26) // "on_pushButton_back_clicked"

    },
    "AddWindow\0firstWindow\0\0on_pushButton_add_clicked\0"
...
void AddWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AddWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddWindow::firstWindow)) {
                *result = 0;
                return;
            }
        }
