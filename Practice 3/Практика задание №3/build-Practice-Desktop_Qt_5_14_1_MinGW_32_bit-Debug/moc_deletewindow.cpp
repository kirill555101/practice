...
#include <memory>
#include "../Practice/deletewindow.h"
...
QT_MOC_LITERAL(3, 26, 28), // "on_pushButton_delete_clicked"
QT_MOC_LITERAL(4, 55, 31), // "on_pushButton_deleteall_clicked"
QT_MOC_LITERAL(5, 87, 26) // "on_pushButton_back_clicked"

    },
    "DeleteWindow\0firstWindow\0\0"
...
void DeleteWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_pushButton_deleteall_clicked(); break;
        ...
        {
            using _t = void (DeleteWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeleteWindow::firstWindow)) {
                *result = 0;
                return;
            }
        }
